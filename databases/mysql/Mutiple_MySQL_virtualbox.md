...
* Download these files
    * [mysql_vm/mmss/setup_mysql_mmss.sh](mysql_vm/mmss/setup_mysql_mmss.sh)
    * [mysql_vm/mmss/accounts_mmss.sql](mysql_vm/mmss/accounts_mmss.sql)
    * [mysql_vm/mmss/mmss_rep.sh](mysql_vm/mmss/mmss_rep.sh)

...
Since MongoDB doesn't work easily under virtual box, I wanted to make a simple replica set
...
So why did I chose port 30001? I needed 4 servers with their own unique ports. In another article I will shard this replica set

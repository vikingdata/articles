...
## ETL tools
* [Generating fake data] (https://www.functionize.com/blog/online-test-data-generators)
* [Python fake data example](https://python.plainenglish.io/generating-a-fake-database-with-python-8523bf6db9ec)
* [SQL fake data](https://vnegrisolo.github.io/postgresql/generate-fake-data-using-sql)
* [Pandas and Faker](https://www.feststelltaste.de/generate-fake-data-for-spring-petclinic-with-pandas-and-faker/)
* [single table generator](https://generatedata.com/generator)
* [Databricks](https://github.com/databrickslabs/dbldatagen)
* [AI generated](https://github.com/abegong/sample_peyote/blob/main/README.md#whats-the-enhance-that-test)
